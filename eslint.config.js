   ...
   rules: {
    ...
    'jsdoc/no-restricted-syntax': [
     'error',
     {
      contexts: [
       {
        comment: 'JsdocTag[tag=/^(?!(param|arg|argument|returns|return|throws|exception|author|version)$).+$/]',
        context: 'any',
        message: 'Strict Mode: You are only allowed to use @param, @returns, @throws, @author, and @version. Extraneous tags are prohibited.'
       }
      ]
     }
    ],
    ...
    'jsdoc/sort-tags': [
     'error',
     {
      ...
      tagSequence: [
        { tags: ['param', 'arg', 'argument', 'returns', 'return', 'throws', 'exception', 'author', 'version'] },
        { tags: [] },
        { tags: ['-other'] }
      ],
